...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.uumdg.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    console.log("Warehouse connected with MongoDB!");
